...
alert(`Something went wrong 😓: /n ${errorData.message || res.statusText || 'Unknown error'}`);
...
<h1 id="contact" class="text-center text-5xl font-black min-h-[20vh]">Contact</h1>

<div class="container rounded-2xl shadow-2xl mx-auto p-6 md:p-12 max-w-4xl font-[Space-mono] min-h-screen bg-[#1e2431] text-white">
